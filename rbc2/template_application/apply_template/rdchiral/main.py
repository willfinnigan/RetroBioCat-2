...
from rbc2.template_application.apply_template.rdchiral.bonds import restore_bond_stereo_to_sp2_atom
from rbc2.template_application.apply_template.rdchiral.chiral import atom_chirality_matches, copy_chirality, \
...
from rbc2.template_application.apply_template.rdchiral.clean import combine_enantiomers_into_racemic, \
    canonicalize_outcome_smiles
from rbc2.template_application.apply_template.rdchiral.initialization import rdchiralReaction, rdchiralReactants, \
    BondDirOpposite
from rbc2.template_application.apply_template.rdchiral.utils import PLEVEL, atoms_are_different
...
def rdchiralRun(rxn, reactants, keep_mapnums=False, combine_enantiomers=True, return_mapped=False,
                check_chiral_products=True, allow_chiral_symmetry=False):
        ...
        for a in outcome.GetAtoms():
            ...
            if not a.HasProp('old_mapno'):
                ...
                if template_atom_could_have_been_tetra(atoms_rt[a.GetAtomMapNum()]):
                    ...
                    # if product has chirality then substrate should have chirality
                    # but this isn't right for biocatalysis, where we can do selective transformations
                    if check_chiral_products:
