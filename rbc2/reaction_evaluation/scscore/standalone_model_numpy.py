"""
Take from https://github.com/connorcoley/scscore on 25Sep19
See included rdchiral_LICENSE
"""
...
#model_path = pkg_resources.resource_filename(__name__, 'model.ckpt-10654.as_numpy.json.gz')
model_path = str(Path(__file__).parents[0]) + '/model.ckpt-10654.as_numpy.json.gz'
score_scale = 5.0
min_separation = 0.25
...
class SCScorer():
    ...
    def restore(self, weight_path=model_path, FP_rad=FP_rad, FP_len=FP_len):
